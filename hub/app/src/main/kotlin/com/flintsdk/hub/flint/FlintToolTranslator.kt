...
/**
 * Translates Flint app tools into MCP-compatible HubTool implementations.
 *
 * For each discovered Flint app, creates:
 ...
 */
@Singleton
class FlintToolTranslator @Inject constructor(
    @ApplicationContext private val context: Context,
    private val logger: HubLogger
) {

    companion object {
        private const val TAG = "FlintToolTranslator"
    ...
    /**
     * Translate all tools from a discovered Flint app into HubTool instances.
     *
     * @param app The discovered Flint app.
     * @return List of HubTool implementations ready to register.
     */
    fun translateApp(app: FlintApp): List<HubTool> {
        ...
        // 2. Standard tools for every Flint app
...
/**
 * Routes an app-specific tool call through the Flint ContentProvider.
 *
 ...
 */
class FlintRemoteTool(
    private val context: Context,
    private val app: FlintApp,
    private val toolDef: FlintToolDef,
    private val prefix: String,
    private val logger: HubLogger
) : HubTool {

    companion object {
        private const val TAG = "FlintRemoteTool"
    }
    ...
    private suspend fun verifyScreen(uri: Uri, expectedScreen: String): String {
        ...
        while (System.currentTimeMillis() - startTime < FlintToolTranslator.SCREEN_VERIFY_TIMEOUT_MS) {
            try {
            ...
            delay(FlintToolTranslator.SCREEN_VERIFY_POLL_MS)
        }
...
/**
 * Reads the structured screen snapshot from an Flint app.
 */
class FlintReadScreenTool(
    private val context: Context,
    private val app: FlintApp,
    private val prefix: String,
    private val logger: HubLogger
    ...
    companion object {
        private const val TAG = "FlintReadScreenTool"
    }
...
/**
 * Gets the current screen name from an Flint app.
 */
class FlintGetScreenTool(
    private val context: Context,
    private val app: FlintApp,
    private val prefix: String,
    private val logger: HubLogger
    ...
    companion object {
        private const val TAG = "FlintGetScreenTool"
    }
...
/**
 * Invokes a semantic action on an Flint app via its ContentProvider.
 */
class FlintActionTool(
    private val context: Context,
    private val app: FlintApp,
    private val prefix: String,
    private val logger: HubLogger
    ...
    companion object {
        private const val TAG = "FlintActionTool"
    }
