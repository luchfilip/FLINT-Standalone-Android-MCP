...
class AcpProcessor(private val environment: SymbolProcessorEnvironment) : SymbolProcessor {
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        val hostAnnotation = "dev.acpsdk.annotations.AcpToolHost"
        ...
        for (symbol in validSymbols) {
            if (symbol !is KSClassDeclaration) {
                logger.error("@AcpToolHost can only be applied to classes", symbol)
                continue
            }
    ...
    private fun extractTools(classDecl: KSClassDeclaration): List<ToolInfo> {
        ...
        val toolAnnotation = "dev.acpsdk.annotations.AcpTool"
    ...
    private fun extractParams(function: KSFunctionDeclaration): List<ParamInfo> {
        val paramAnnotation = "dev.acpsdk.annotations.AcpParam"
    ...
    private fun generateRouter(classDecl: KSClassDeclaration, tools: List<ToolInfo>) {
        ...
        val routerClassName = "AcpRouter_$hostClassName"
        ...
        val code = buildString {
            appendLine("// AUTO-GENERATED by ACP KSP Processor — do not edit")
            appendLine("package $packageName")
            appendLine()
            appendLine("import dev.acpsdk.annotations.AcpToolHandler")
            appendLine()
            appendLine("class $routerClassName(private val host: $hostClassName) : AcpToolHandler {")
    ...
    private fun generateSchemaHolder(tools: List<ToolInfo>, screens: Set<String>) {
        ...
        val file = codeGenerator.createNewFile(
            ...
            "dev.acpsdk.generated",
            "AcpSchemaHolder"
        )

        val code = buildString {
            appendLine("// AUTO-GENERATED by ACP KSP Processor — do not edit")
            appendLine("package dev.acpsdk.generated")
            appendLine()
            appendLine("object AcpSchemaHolder {")
...
class AcpProcessorProvider : SymbolProcessorProvider {
    override fun create(environment: SymbolProcessorEnvironment): SymbolProcessor {
        return AcpProcessor(environment)
    }
}
